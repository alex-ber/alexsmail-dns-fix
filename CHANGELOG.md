...
- Now we're using golden alexberkovich/ubuntu-snapshot:2026-08-12 as bas image.
...
- Now we're using golden alexberkovich/ubuntu-snapshot:2025-06-16 as bas image.
- uv version was minour bumped up.

## [0.2.4] - 2026-05-15

### Added

- get-image-hash && get-pkg-version && update-uv-lock are added as standalone services.

## [0.2.3] - 2026-05-15

### Added

- mise.toml - for those that uses mise.
- docker-compose.yml wrappe.
- Added env.example to create .env.
- Updated README.md.
